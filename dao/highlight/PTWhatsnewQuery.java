...
@Stateless
@Local(PTWhatsnewQueryLocal.class)
public class PTWhatsnewQuery extends GenericDao<PTWhatsnewEntity> implements PTWhatsnewQueryLocal {
	...
	public Long count(HighlightSearchForm form) {
		String sql = "SELECT COUNT(o) FROM PTWhatsnewEntity o";
	...
	@Override
	public List<PTWhatsnewEntity> search(HighlightSearchForm form, Integer offset, Integer maxResult, List<SortMeta> sortList) {
		String sql = "SELECT o FROM PTWhatsnewEntity o";
		ConditionResult condition = getCondition(form);
		sql += condition.getWhereStatement();
