...
@Stateless
@Local(VideoGalleryQueryLocal.class)
public class VideoGalleryQuery extends GenericDao<VideoGalleryEntity> implements VideoGalleryQueryLocal {
	...
	public Long count(HighlightSearchForm form) {
		String sql = "SELECT COUNT(o) FROM VideoGalleryEntity o";
	...
	@Override
	public List<VideoGalleryEntity> search(HighlightSearchForm form, Integer offset, Integer maxResult, List<SortMeta> sortList) {
		String sql = "SELECT o FROM VideoGalleryEntity o";
		ConditionResult condition = getCondition(form);
		sql += condition.getWhereStatement();
